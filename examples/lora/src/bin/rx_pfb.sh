...
RX_OFFSET="--rx-freq-offset=1.3e6"
...
cargo run --bin rx_pfb ${BUILD_TYPE} -- ${SPREADING_FACTOR} ${BANDWIDTH} ${CENTER_FREQ} ${RX_OFFSET} ${DEVICE_FILTER} ${RX_GAIN} ${RX_ANTENNA} ${SAMPLE_RATE}